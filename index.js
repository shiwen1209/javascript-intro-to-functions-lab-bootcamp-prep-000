...
function sayHiToGrandma(string){if(string==="I love you, Grandma."){console.log("I love you, too.");}else if(string===string.toUpperCase()){console.log("YES INDEED!");}else{console.log("I can't hear you!");}}
